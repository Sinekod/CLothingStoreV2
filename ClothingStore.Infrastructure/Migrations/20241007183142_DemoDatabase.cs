...
{
    /// <inheritdoc />
    public partial class DemoDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsShoe = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductImages_Colours_ColourId",
                        column: x => x.ColourId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_ProductImages_ProductImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateWhenOrdered = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Tottal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DeliveryToAddressId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DeliveryToAddressId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductItems_ProductImages_ProductImageId",
                        column: x => x.ProductImageId,
                        principalTable: "ProductImages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ProductImageId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_ColourId",
                table: "ProductImages",
                column: "ColourId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_ProductImageId",
                table: "ProductItems",
                column: "ProductImageId");
